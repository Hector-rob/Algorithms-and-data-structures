...
void HashTable::displayDetails(string ip) { //O(N), Muestra una ip y sus detalles a partir de la llave y resumen en la hash table
    cout << ip;
    bool found = false;
...
void HashTable::displayAll() { //O(N), Muestra la tabla entera con los valores encadenados en cada celda
